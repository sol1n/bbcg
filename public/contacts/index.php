...
<div class="feedback-block">
    <div class="wrapper">
        <form action="/api/feedback/" method="POST" class="feedback-block-form" data-validate data-form-ajax>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <input id="feedback-form-name" type="text" class="form-input" name="name" value="<?=$user['DISPLAY_NAME']?>" required placeholder="Иван Иванов">
                    </div>
                </div>
            ...
            <div data-recaptcha="6LcPCEAUAAAAAGqTbJAUzUCbGkQ5vE-01o_Fvio2"></div>
