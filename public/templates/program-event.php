                    ...
                    <div class="m-t-md m-b-md">
                        <ul class="speakers-list">
                            <li class="speakers-list-item">
                                <a href="#" class="speakers-list-item-link">
                                    <div class="speakers-list-item-photo">
                                        <img src="../assets/images/tmp/speakers/speaker-2.png" alt="">
                                    </div>
                            ...
                            <li class="speakers-list-item">
                                <a href="#" class="speakers-list-item-link">
                                    <div class="speakers-list-item-photo">
                                        <img src="../assets/images/tmp/speakers/speaker-3.png" alt="">
                                    </div>
                                    <div class="speakers-list-item-text">
                                        <div class="speakers-list-item-title">
                                            Андреас Шляйхер
                            ...
                            <li class="speakers-list-item">
                                <a href="#" class="speakers-list-item-link">
                                    <div class="speakers-list-item-photo">
                                        <img src="../assets/images/tmp/speakers/speaker-1.png" alt="">
                                    </div>
                                    <div class="speakers-list-item-text">
                                        <div class="speakers-list-item-title">
                                            Анне-Берит Кавли
