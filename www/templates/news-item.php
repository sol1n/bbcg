...
<main class="main-container main-container-with-header">
        ...
        <div class="news-item-wrapper">
            <div class="news-item m-t-xl m-b-xl">
                <div class="news-item-content">
                    ...
                    <blockquote class="blockquote m-t-lg m-b-lg">
                        Собственные частные марки (СТМ), Private Labels розничных сетей. Рынок товаров под частными марками успешно развивается во всем мире: доля покупателей Private Labels растет непрерывно, глобальный кризис только усиливает спрос на эту категорию.
                    ...
                    <?php include "blocks/gallery-block-slider.php"; ?>
                    ...
                    <ul class="ul-square-blue">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>Дочерний элемент списка №1</li>
                                <li>Дочерний элемент списка №2</li>
                                <li>Дочерний элемент списка №3</li>
                            </ul>
                        </li>
                ...
                <aside class="news-item-sidebar">
                    <div class="news-item-meta">
                        <div class="news-item-meta-date">
                            <span class="news-item-meta-date-day">16</span> декабря, 2017
                        </div>
                    </div>
    ...
    <section class="other-news-block">
        <div class="wrapper">
            <div class="other-news-block-title">
                Другие новости
            </div>
            <div class="row">
