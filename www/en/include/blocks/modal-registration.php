...
<form action="/api/registration/?lang=en" method="POST" enctype="multipart/form-data" class="main-reg-form registration-form registration-modal-form" data-validate data-form-ajax data-form-ajax-overlay="#registration-form-overlay" data-crm-token="main-reg-form">
