<?
    ...
    if ($arParams['LANG'] == 'en') {
        $arResult['INDEX_PAGE_URL'] = '/en/academy/';
    } else {
        $arResult['INDEX_PAGE_URL'] = '/academy/';
    }

    foreach ($arResult['ITEMS'] as $k => $item) {
        $year = FormatDate('Y', MakeTimeStamp($item["PROPERTIES"]['END']['VALUE'], "DD.MM.YYYY HH:MI:SS"));
