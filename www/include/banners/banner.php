    ...
    <div class="wrapper">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-2 banner-right">
                <a class="banner-button button button-light-burgundy" href="/shop-forever/about/sberbank-2025-otdelenie-budushchego/?utm_source=web&utm_medium=banner&utm_campaign=sberbank" target="_blank">РЕГИСТРАЦИЯ</a>
            </div>
        </div>
    </div>
</div>
