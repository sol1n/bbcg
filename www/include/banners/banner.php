        ...
        <div class="row">
            <div class="col-md-2 col-sm-2 banner-left">
                <a href="/shop-forever/?utm_source=banner&utm_medium=MF&utm_campaign=19_12#summit-registration-block" target="_blank">
                    <img src="/assets/images/banner/magaz-1.jpg"/>
                </a>
            </div>
            <div class="col-md-8 col-sm-8 banner-center">
                <img src="/assets/images/banner/magaz-2.jpg"/>
            </div>
            <div class="col-md-2 col-sm-2 banner-right">
                <a class="banner-button button button-light-burgundy" href="/shop-forever/?utm_source=banner&utm_medium=MF&utm_campaign=19_12#summit-registration-block" target="_blank">РЕГИСТРАЦИЯ</a>
            </div>
        </div>
    </div>
</div>
