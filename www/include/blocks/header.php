<header class="main-header">
    <div class="wrapper">
        ...
        <div class="main-header-lang">
            <a href="<?=localizeUrl($_SERVER['REQUEST_URI'], 'ru'); ?>" class="main-header-lang-item active">Рус</a>
            <a href="<?=localizeUrl($_SERVER['REQUEST_URI'], 'en'); ?>" class="main-header-lang-item">Eng</a>
        </div>
